...
%%{{{--| MD @ LBJ
\cventry{05/2014 -- 03/2022}{Internal Medicine / Critical Care Physician}{LBJ TMC}{Pago-Pago}{American Samoa}{LBJ TMC is a rural community hospital of 150 bed capacity, with 7 ICU beds and 27 beds in  medical ward.
\newline -- Assessing and treating of acute, chronic, and complex illnesses, in adolescents, adults, and elderly in accordance with the principles of evidence-based medical practice following USA guidelines.
\newline -- Evaluating patients when different illnesses, that occurs together or in situations where the diagnosis may be obscure.
\newline -- Ordering laboratory, as well, as imaging tests, and subsequently interpreting results.
\newline -- Prescribing or administering medication, therapy, and other specialized medical care to treat or prevent illness, disease, or injury.
\newline -- Monitoring patient's conditions and progress and re-evaluate treatments as necessary.
\newline -- Collecting, recording, maintaining and analyzing patient information, such as medical history, reports, and examination results on daily basis.
\newline -- Immunizing patients to protect them from preventable diseases.
\newline -- Explaining and performing procedures and discussing test results or prescribed treatments to patients.
\newline -- Participating in the island-wide colorectal screening program together with surgical team, performing supervised upper and lower endoscopies.
\newline -- Advising patients and community members concerning diet, activity, hygiene, and disease prevention.
\newline -- Referring patient to medical specialist or other practitioner when necessary.
\newline -- Providing in-flight medical escort during patient's transfer to other medical facilities
\newline -- Providing consulting services to other doctors caring for patients with special or difficult problems in ER, ICU, Surgical ward, Dental, Dialysis clinics.
\newline -- Advising surgeon of a patient's risk status and recommend appropriate intervention to minimize risk.
\newline -- Directing and coordinating activities of nurses, assistants, specialists, therapists, and other medical staff.
\newline -- Proctoring physician assistants in training from Bryant University during their rotations.
\newline -- Participating in COVID19 planning, preparation and vaccinations events.
\newline -- Participating in the administrative meeting when required (Vice-chairman of the infection committee)
\newline -- Leading and coordinating tele-medecine effort.
} %}}}
