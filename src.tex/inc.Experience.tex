...
%MajorKey {{{
%\cventry{03/2022--year}{Python developer}{MajorKey Technologies Inc}{Lombard, IL}{}{Description}                % arguments 3 to 6 are optional
%}}}
...
\newline -- Participated in the administrative meeting when required as a Vice-chairman of the infection committee. 
